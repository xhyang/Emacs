...
(define-emms-simple-player mplayer '(file) (regexp-opt '(".mp3" ".MP3")) ".wav" "-l" "-t " "3:00")
...
(global-set-key (kbd "<M-f1>")    'emms-google-for-lyrics)
(global-set-key (kbd "<M-f2>")    'emms-smart-browse)
(global-set-key (kbd "<M-f3>")    'emms-playlist-mode-go)
